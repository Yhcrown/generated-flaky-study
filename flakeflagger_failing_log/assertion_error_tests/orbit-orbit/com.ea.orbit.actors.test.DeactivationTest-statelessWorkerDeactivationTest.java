  ...
  final Set<UUID> set2=new HashSet<>();
{
  ...
  set2.retainAll(set1);
// --> Flaky assertion: possible message: expected:<1> but was:<2>; expected:<1> but was:<4>; expected:<1> but was:<5>; expected:<1> but was:<7>; expected:<1> but was:<3>; expected:<1> but was:<6>;         assertEquals(1, set2.size());
}
